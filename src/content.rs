...
/// A content-09 §3.3 message ID: 32 octets, one naming the hash algorithm and 31 of hash output
/// over the sender URI, the room URI, the encoded message and the salt. The §4.1 CDDL states it as
/// `MessageId = bstr .size 32`, which `from_content08_cbor` enforces on decode.
///
/// [`crate::message_id::derive_message_id`] derives one, and documents what a match between two of
...
mod tests {
    ...
    use crate::test_vectors::OFFICIAL_VECTORS;
